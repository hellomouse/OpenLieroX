...
////////////////
// Create a SDL rect
inline SDL_Rect MakeRect(short int x, short int y, short unsigned int w, short unsigned int h)
{
	SDL_Rect r = {x, y, w, h};
	return r;
}
...
//////////////
// Draw the image with a huge amount of options
inline void DrawImageAdv(SDL_Surface * bmpDest, SDL_Surface * bmpSrc, short int sx, short int sy, short int dx, short int dy, short unsigned int w, short unsigned int h) {
	SDL_Rect r1 = { dx, dy, 0, 0 };
	SDL_Rect r2 = { sx, sy, w, h };
	DrawImageAdv( bmpDest, bmpSrc, r1, r2);
}
inline void DrawImageAdv(SDL_Surface * bmpDest, const SmartPointer<SDL_Surface> & bmpSrc, short int sx, short int sy, short int dx, short int dy, short unsigned int w, short unsigned int h) {
...
///////////////
// Simply draw the image
inline void DrawImage(SDL_Surface * bmpDest, SDL_Surface * bmpSrc, short int x, short int y) {
	SDL_Rect r = { x, y, 0, 0 };
	DrawImage( bmpDest, bmpSrc, r);
}
inline void DrawImage(SDL_Surface * bmpDest, const SmartPointer<SDL_Surface> & bmpSrc, short int x, short int y) {
